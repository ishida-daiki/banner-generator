...
export function useConfetti() {
    ...
    return { count, size, setSize, isRandom, fillOpacity, fillColor, setFillColors, fillColors, handleFillColorInput, handleFillOpacityInput, handleCountInput, handleChange, handleCreateButtonClick, minimum, maximum };
}